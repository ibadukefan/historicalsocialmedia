      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            <NavItem href="/notifications" icon={Bell} label="Alerts" badge={3} />
          </nav>
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden pb-4 border-t border-border pt-4">
            <div className="flex flex-col gap-2">
              ...
              <MobileNavItem href="/notifications" icon={Bell} label="Notifications" badge={3} />
...
function MobileNavItem({ href, icon: Icon, label, active, badge }: NavItemProps) {
  return (
    ...
    >
      ...
      <span>{label}</span>
      {badge && badge > 0 && (
        <span className="ml-auto h-6 w-6 flex items-center justify-center rounded-full bg-destructive text-destructive-foreground text-sm font-medium">
          {badge}
        </span>
      )}
    </Link>
